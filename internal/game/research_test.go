...
func TestCompleteResearchFieldRejectsPrematureAndCrossFieldCompletion(t *testing.T) {
	...
	premature.Empires[0].Research = &core.ResearchState{TechFieldID: 56, TechnologyIDs: []int{155}, ProgressMilli: 149 * core.EconomyScale}
	...
	crossField.Empires[0].Research = &core.ResearchState{TechFieldID: 56, TechnologyIDs: []int{22}, ProgressMilli: 150 * core.EconomyScale}
