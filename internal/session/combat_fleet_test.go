...
func TestGameSessionCombatFleetSubsetMoveObserverIsolationAndDeterministicReplay(t *testing.T) {
	...
	if core.StateSchemaVersion != 21 || viewA.State.SchemaVersion != 21 {
		t.Fatalf("observer schema=%d constant=%d want=21", viewA.State.SchemaVersion, core.StateSchemaVersion)
	}
