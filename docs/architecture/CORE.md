...
- materialized `ColonyPopulationDynamics` for capacity, local/imported/exported Food, Production sustenance, projected Growth and Starvation,
- discrete Empire Freighter pool plus `EmpireFoodLogistics` transport/cost/surplus valuation snapshot,
