...
6. **Slice 20 - Espionage / intelligence baseline.** Reserved by product decision for real Spy acquisition/allocation, defensive/offensive missions, Espionage/Sabotage resolution, race/technology modifiers, player-safe projection, built-in AI and first-class browser integration. Slices 18/19 remain intentionally unassigned for now.

Keep **additional Tactical breadth beyond Slice 15.5** (broad weapon/special/facing/retreat/planetary families), treaty/trade diplomacy, Leaders, Economy/Population fidelity, full custom Race Designer, Council/Orion/Antaran victories, random events, multiplayer/external AI and presentation unnumbered until the next audit after the prepared Slice 20 baseline.
