...
- Fleet/Diplomacy-derived blockade production and missing original Treasury categories/deficit policy,
...
Race-aware Population cohorts are complete and preserved in `docs/research/POPULATION_COHORTS_2026-08-29.md`. The next queued slice is the minimum canonical strategic Fleet/Diplomacy state required to derive system blockade production for the existing Food-logistics consumer.
