...
| `technologies.json` | 203 original technology identities/IDs + 82 TechFields/cost/topology metadata | starting ownership, breakthrough resolution and first legal research selection are implemented; Creative/Uncreative, hyper-advanced costs and broader effects remain |
