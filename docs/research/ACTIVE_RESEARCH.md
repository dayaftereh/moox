...
- Current objective: **Serve B2-V for direct review: Colony Build card now shows current PP/%/ETA progress; Kolonie-Info exposes live authoritative Growth and BC component breakdowns, including draft Housing. Bank/Planetary Stock Exchange BC mechanics remain unimplemented and therefore absent. G4-C remains open.**
