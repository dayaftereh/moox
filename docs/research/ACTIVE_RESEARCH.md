...
- Current objective: **Serve B2-W for direct review: no standalone Colony Info button; tap Growth or Colony-BC values for their own live authoritative breakdown, while Planet Info is a compact `?` trigger. G4-C remains open.**
