...
- Active implementation slice: **Slice 16.1 - New Game visual selection grammar, Gate 1**.
...
- Current objective: **complete Slice 16.1 Gate 1 audit/prototype and freeze the reusable New Game visual-selector direction before later 16.x breadth.**
