...
- Current objective: **review and freeze the revised single-card, image-dominant Slice 16.1 selector after user UI/art review; do not freeze the earlier side-arrow/nested-card prototype.**
