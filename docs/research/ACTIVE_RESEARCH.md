...
- Current objective: **Serve B2-U for direct review: compact Build-management header, one Current build with PP/%/ETA, and a future-only Queue with no duplicate current project. G4-C remains open.**
