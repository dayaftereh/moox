...
- Active implementation slice: **Slice 16.5 - Starting Technology visual selector; Gate 1 active**.
...
- Current objective: **audit the authoritative `pre_warp` / `average` / `advanced` start contract, exact technology/start-state effects, race/RNG interactions and a three-stage visual prototype before any Gate-2 freeze.**
