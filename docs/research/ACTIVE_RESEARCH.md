...
- Active implementation slice: **Slice 16.1 - New Game visual selection grammar; Gate 1 complete, Gate 2 next**.
...
- Current objective: **Slice 16.1 Gate 2 freeze: lock the reusable selector component contract, responsive/accessibility behavior, asset conventions and unsupported-state presentation before later 16.x breadth.**
