...
Implemented in the dedicated follow-up `SLICE_15_6_GATE3_TACTICAL_MOBILE_PERFORMANCE_DAMAGE_FEEDBACK_2026-09-12.md`: one-path reachable grid instead of per-cell rectangles, baseline Nuclear/Fusion movement 10/12 instead of 20/22, direct centered native Tactical ship SVGs with tight viewBox, and slower beam impact with authority-derived floating Armor/Structure damage numbers plus future-ready Shield color. Browser QA on isolated 7177 is green for movement and rendering.
