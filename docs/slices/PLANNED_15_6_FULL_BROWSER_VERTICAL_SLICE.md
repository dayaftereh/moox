...
- [ ] Audit all 15.1-15.5 acceptance evidence and unresolved cross-slice UX seams.
- [ ] Define the exact canonical browser playthrough and checkpoints from launch to victory, including at least one supported interactive Tactical battle path where the canonical scenario provides one.
...
- [ ] Define automated/manual browser E2E strategy including save/reload/reconnect and strategic <-> Tactical transitions.
