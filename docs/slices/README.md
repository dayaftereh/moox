...
1. `PLANNED_01_COLONY_BASE_SAME_SYSTEM_COLONIZATION.md`
2. `PLANNED_02_OUTPOST_SHIP_SUPPLY_RANGE.md`
3. `PLANNED_03_MILITARY_SHIP_CORE_DESIGN_BASELINE.md`
4. `PLANNED_04_COMBAT_FLEET_MOVEMENT_MERGE_SPLIT.md`
5. `PLANNED_05_COMMAND_POINTS_SHIP_MAINTENANCE.md`
6. `PLANNED_06_STRATEGIC_HOSTILE_ENCOUNTERS_BATTLE_HANDOFF.md`
7. `PLANNED_07_TACTICAL_SHIP_COMBAT_BASELINE.md`
