...
- **Slice 16.4 - Gate 3 complete / Gate 4 next** - `_OPEN_PRESET_RACE_PORTRAITS_CAROUSEL_2026-09-16.md`; 13-race catalog, Human/Klackon player support, fixed Darlok opponent, canonical portraits and shared race carousel are implemented; final closure acceptance remains.
...
1. `PLANNED_16_NEW_GAME_PRESET_RACE_BREADTH.md` - parent Slice-16 program; Slices 16.1-16.3 are closed and Slice 16.4 has Gate 3 complete / Gate 4 next.
