...
- **Slice 16.4 - Gate 4 active** - `_OPEN_PRESET_RACE_PORTRAITS_CAROUSEL_2026-09-16.md`; final portrait provenance/accessibility/determinism/browser/full-regression closeout is in progress.
...
1. `PLANNED_16_NEW_GAME_PRESET_RACE_BREADTH.md` - parent Slice-16 program; Slices 16.1-16.3 are closed and Slice 16.4 Gate 4 is active.
