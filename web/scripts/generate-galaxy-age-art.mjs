...
const configs = [
  { id: 'mineral_rich', assetId: 'mineral-rich', marker: 0.18, mineral: 1.0, organic: 0.28, accent: '#e3aa55', secondary: '#ffe7aa' },
  { id: 'normal', marker: 0.50, mineral: 0.66, organic: 0.66, accent: '#79b8e8', secondary: '#dff4ff' },
  { id: 'organic_rich', assetId: 'organic-rich', marker: 0.82, mineral: 0.28, organic: 1.0, accent: '#6fc8b4', secondary: '#d9fff5' },
]
