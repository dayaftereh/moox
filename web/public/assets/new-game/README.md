...
Slice 16.1 registers the five generated Galaxy Size SVGs. Slice 16.2 registers five original deterministic Difficulty command-crest SVGs generated by `web/scripts/generate-difficulty-art.mjs`. Later 16.x slices add entries only for assets that actually exist in the repository.
